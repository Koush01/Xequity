    ...
    return (
        <div className={styles.container}>
            ...
            <div className={styles.ticketsSection}>
                ...
                {userBuyTickets.length > 0 ? userBuyTickets.map((ticket, idx) => (
                    <div key={idx} className={styles.ticketItem}>
                        Price: {ticket.price}, Qty: {ticket.quantity},<button onClick={() => cancelBuy(ticket)}>Cancel</button>
                    </div>
                )) : <p>No buy tickets</p>}
            </div>
            ...
            <div className={styles.ticketsSection}>
                ...
                {userSellTickets.length > 0 ? userSellTickets.map((ticket, idx) => (
                <div key={idx} className={styles.ticketItem}>
                    Price: {ticket.price}, Qty: {ticket.quantity},<button onClick={() => cancelSell(ticket)}>Cancel</button>
                </div>
                )) : <p>No sell tickets</p>}
            </div>
            </div>
                ...
                {/* Main Content */}
                <div className={styles.tradingMain}>
